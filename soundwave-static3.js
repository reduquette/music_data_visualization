...
function soundwaveStatic3(){
  var margin = {top: 10, right: 100, bottom: 35, left: 120},
...
var svgStatic3 = d3.select("#soundwave-static3")
  .append("svg")
...
d3.csv("averages.csv",d3.autoType).then(data => {
    ...
    var defs4 = svgStatic3.append("defs");

    //Filter for the outside glow
    var filter4 = defs4.append("filter")
        .attr("id","glow4");
    filter4.append("feGaussianBlur")
        .attr("stdDeviation","4")
        .attr("result","coloredBlur");
    var feMerge4 = filter4.append("feMerge");
    feMerge4.append("feMergeNode")
        .attr("in","coloredBlur");
    feMerge4.append("feMergeNode")
        .attr("in","SourceGraphic");
  
   
    var path21 = svgStatic3.append("path")
       .datum(dataReady)
       .attr("fill", "none")
       ...
       var path22 = svgStatic3.append("path")
                 .datum(dataReady)
                 .attr("fill", "none")
       ...
       var path23 = svgStatic3.append("path")
                           .datum(dataReady)
                           .attr("fill", "none")
   ...
   path21
    ...
    svgStatic3
      ...
      .enter()
       ...
       //Draw the Rectangle
       var rectangle3 = svgStatic3.append("rect")
       .attr("rx", 8)
       .attr("ry", 8)
       .attr("x", 10)
       .attr("y", 10000)
